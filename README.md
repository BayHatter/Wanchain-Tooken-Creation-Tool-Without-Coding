# Wanchain Token Creation Tool

A simple frontend tool to create tokens on the Wanchain (WAN) network using a backend API.
...
- Insert this project link https://github.com/BayHatter/Wanchain-Tooken-Creation-Tool-Without-Coding.git
- And press deploy
- Congrats your Wanchain Token Creation Tool installed on your vercel.com account
...
- Then donwload our code from https://github.com/BayHatter/Wanchain-Tooken-Creation-Tool-Without-Coding
- Upload into your Github repo.
- Edit the file public/config.json and insert your Wanchain wallet address for receiving fees. Also set fee in WAN that you want to charge
